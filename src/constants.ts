...
export const ACCESSORIES: Accessory[] = [
    ...
    { id: 'glass_2', name: { sv: '2-glas', da: '2-lags', de: '2-fach', en: '2-pane' }, category: 'Glass', imageSrc: 'https://wyjykasevullaqvhnuef.supabase.co/storage/v1/object/public/konfigurator-images/glass/glass_2.png' },
    { id: 'glass_3', name: { sv: '3-glas', da: '3-lags', de: '3-fach', en: '3-pane' }, category: 'Glass', imageSrc: 'https://wyjykasevullaqvhnuef.supabase.co/storage/v1/object/public/konfigurator-images/glass/glass_3.png' },
...
export const PRODUCTS: Product[] = [
    ...
    { name: '2-LUFT(DKV+DH) Flyttbar mittpost', category: 'Okna', imageSrc: 'https://wyjykasevullaqvhnuef.supabase.co/storage/v1/object/public/konfigurator-images/fonster/fonster_2-LUFT(DKV+DH)_flytb_mit.png' },
    ...
    { name: '2-LUFT(DV+DKH) Flyttbar mittpost', category: 'Okna', imageSrc: 'https://wyjykasevullaqvhnuef.supabase.co/storage/v1/object/public/konfigurator-images/fonster/fonster_2-LUFT(DV+DKH)_flytb_mit.png' },
    ...
    { name: 'ALU 2-LUFT(DKV+DH) Flyttbar mittpost', category: 'Okna', imageSrc: 'https://wyjykasevullaqvhnuef.supabase.co/storage/v1/object/public/konfigurator-images/fonster/fonster_ALU_2-LUFT(DKV+DH)_flytb_mit.png' },
    ...
    { name: 'ALU 2-LUFT(DV+DKH) Flyttbar mittpost', category: 'Okna', imageSrc: 'https://wyjykasevullaqvhnuef.supabase.co/storage/v1/object/public/konfigurator-images/fonster/fonster_ALU_2-LUFT(DV+DKH)_flytb_mit.png' },
    ...
    { name: 'TRÄ 2-LUFT(DKV+DH) Flyttbar mittpost', category: 'Okna', imageSrc: 'https://wyjykasevullaqvhnuef.supabase.co/storage/v1/object/public/konfigurator-images/fonster/fonster_TRA_2-LUFT(DKV+DH)_flytb_mit.png' },
    ...
    { name: 'TRÄ 2-LUFT(DV+DKH) Flyttbar mittpost', category: 'Okna', imageSrc: 'https://wyjykasevullaqvhnuef.supabase.co/storage/v1/object/public/konfigurator-images/fonster/fonster_TRA_2-LUFT(DV+DKH)_flytb_mit.png' },
...
export const TRANSLATIONS: Record<string, any> = {
    sv: {
        ...
        missing_dimensions: 'Vänligen ange både bredd och höjd.',
        ...
        tip_uw: 'Värmeisoleringskoefficient. Ju lägre värde, desto bättre isolering och lägre uppvärmningskostnader.',
        tip_db: 'Ljudisoleringsindex. Ett högre värde innebär bättre dämpning av buller utifrån.',
        tip_chambers: 'Antal kammare i profilen. Fler kammare ger vanligtvis bättre stabilitet och isolering.',
        tip_depth: 'Profilens monteringsdjup. Ett större djup möjliggör användning av tjockare glaspaket.',
    ...
    da: {
        ...
        missing_dimensions: 'Angiv venligst både bredde og højde.',
        ...
        tip_uw: 'Varmeisoleringskoefficient. Jo lavere værdi, jo bedre isolering og lavere varmeomkostninger.',
        tip_db: 'Lydisoleringsindeks. En højere værdi betyder bedre dæmpning af støj udefra.',
        tip_chambers: 'Antal kamre i profilen. Flere kamre giver normalt bedre stabilitet og isolering.',
        tip_depth: 'Profilens monteringsdybde. En større dybde giver mulighed for brug af tykkere glaspakker.',
    ...
    de: {
        ...
        missing_dimensions: 'Bitte geben Sie Breite und Höhe an.',
        ...
        tip_uw: 'Wärmedämmwert. Je niedriger der Wert, desto besser die Isolierung und geringer die Heizkosten.',
        tip_db: 'Schallschutzwert. Ein höherer Wert bedeutet eine bessere Dämpfung von Außengeräuschen.',
        tip_chambers: 'Anzahl der Kammern im Profil. Mehr Kammern sorgen in der Regel für bessere Stabilität und Isolierung.',
        tip_depth: 'Bautiefe des Profils. Eine größere Tiefe ermöglicht den Einsatz dickerer Glaspakete.',
    ...
    en: {
        ...
        missing_dimensions: 'Please enter both width and height.',
        ...
        tip_uw: 'Thermal insulation coefficient. The lower the value, the better the insulation and lower heating costs.',
        tip_db: 'Acoustic insulation index. A higher value means better damping of outside noise.',
        tip_chambers: 'Number of chambers in the profile. More chambers usually provide better stability and insulation.',
        tip_depth: 'Profile installation depth. A greater depth allows for the use of thicker glass packages.',
    ...
    pl: {
        ...
        subheader: 'Profesjonalne systemy okienne na klimat nordycki. Stwórz swoje zapytanie poniżej.',
        step1: 'WYBIERZ PROFIL', step2: 'WYBIERZ PRODUKT', step3: 'KONFIGURUJ JEDNOSTKI',
        btn_send: 'WYŚLIJ ZAPYTANIE', btn_add: 'DODAJ JEDNOSTKĘ', summary: 'TWOJA LISTA PROJEKTOWA',
        empty: 'Wybierz produkt, aby zacząć.', ai: 'G-Assistant: Gotowy do analizy technicznej.',
        width: 'SZEROKOŚĆ (MM)', height: 'WYSOKOŚĆ (MM)', quantity: 'ILOŚĆ', glassType: 'TYP SZKŁA', glass_type_label: 'TYP SZKŁA',
        glass_standard: 'Standard', glass_tempered: 'Hartowane', glass_security: 'Bezpieczne', glass_frosted: 'Matowe', glass_acoustic: 'Dźwiękoszczelne', glass_solar: 'Przeciwsłoneczne',
        ...
        vent_none: 'BEZ', vent_with: 'Z', profile_label: 'PROFIL', select_first: 'Proszę najpierw wybrać profil!',
        vent_none_acc: 'Bez wentylacji', vent_standard: 'Areco AMO', vent_hygro: 'Aereco EMM', vent_press: 'Ventair Simpress',
        handle_white: 'Biała (Standard)', handle_silver: 'Srebrna', handle_black: 'Czarna', handle_button: 'Biała z przyciskiem', handle_key: 'Z kluczykiem', handle_child: 'Zabezpieczenie przed dziećmi',
        nav_config: 'Konfiguracja', nav_tech: 'Analiza Techniczna',
        btn_confirm: 'DODAJ DO LISTY', btn_change: 'ZMIEŃ', step_done: 'WYBRANO',
        last_used: 'OSTATNIO WYBRANY',
        missing_dimensions: 'Proszę podać szerokość i wysokość.',
        cat_okna: 'Okna', cat_drzwi: 'Drzwi', cat_terrassystem: 'Systemy tarasowe',
        colorOut: 'KOLOR ZEWNĄTRZ', colorIn: 'KOLOR WEWNĄTRZ',
        admin_title: 'ADMIN: PRZYPISANIE PRODUKTÓW', admin_desc: 'Wybierz produkty dostępne dla każdego profilu.',
        admin_profiles: 'ZARZĄDZANIE PROFILAMI', admin_acc: 'ZARZĄDZANIE AKCESORIAMI',
        admin_status: 'STATUS', admin_active: 'AKTYWNY', admin_disabled: 'WYŁĄCZONY',
        admin_add_profile: 'DODAJ PROFIL', admin_name: 'NAZWA', admin_type: 'TYP',
        admin_image: 'URL OBRAZU', admin_desc_field: 'OPIS',
        admin_pass_title: 'DOSTĘP OGRANICZONY', admin_pass_desc: 'Wprowadź hasło administratora.',
        admin_pass_placeholder: 'HASŁO', admin_pass_btn: 'ZALOGUJ', admin_pass_error: 'Błędne hasło!',
        admin_edit: 'EDYTUJ', admin_delete: 'USUŃ', admin_save: 'ZAPISZ', admin_cancel: 'ANULUJ',
        info_uw: 'Wartość Uw', info_acoustics: 'Akustyka', info_chambers: 'Komory', info_depth: 'Głębokość', info_description: 'Opis', info_select: 'Wybierz ten profil',
        info_view_profile: 'Widok profilu', info_view_section: 'Widok przekroju',
        tip_uw: 'Współczynnik przenikania ciepła. Im niższa wartość, tym lepsza izolacja i niższe koszty ogrzewania.',
        tip_db: 'Wskaźnik izolacji akustycznej. Wyższa wartość oznacza lepsze tłumienie hałasu z zewnątrz.',
        tip_chambers: 'Liczba komór w profilu. Więcej komór zazwyczaj zapewnia lepszą stabilność i izolację.',
        tip_depth: 'Głębokość zabudowy profilu. Większa głębokość pozwala na zastosowanie grubszych pakietów szybowych.',
        anchors_total: 'Sugerowana liczba kotew',
        transport_terminal: 'Darmowa dostawa do terminala',
        transport_missing_prefix: 'brakuje',
        transport_missing_suffix: 'do darmowej dostawy pod adres z rozładunkiem',
        transport_home: 'Masz darmową dostawę pod adres z rozładunkiem',
        units_count: 'Liczba jednostek'
    }
};
